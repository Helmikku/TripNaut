...
<script>
	...
	var user = new Naut(<?php echo($user->id()); ?>, <?php echo(json_encode($user->login())); ?>, <?php echo($user_role); ?>, new Panel(document.getElementById('user_panel'),[[null,-200,null,null],[null,0,null,null]]));
	...
	// --- TRIP ---
	var trip = new Trip(<?php echo($trip['id']); ?>,<?php echo(json_encode($trip['title'])); ?>,new Date("<?php echo($trip['start']->format('m/d/Y')); ?>"),<?php echo($trip['duration']);?>,<?php echo($trip['blocks']); ?>,<?php echo($trip['locked']); ?>,<?php echo($trip['locker_id']); ?>,<?php echo($trip['creator_id']); ?>,<?php echo($trip['administration']); ?>,[],false,true,new Panel(document.getElementById('time_panel'),[[null,null,null,-200],[null,null,null,0]]));
